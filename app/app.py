...
from app.rfi.revision.web_pages import router as rfi_revision_pages_router
...
app.include_router(rfi_pages_router)
app.include_router(rfi_revision_pages_router)
